...
def build_args():
    ...
    parser.add_argument("--sample_name", type=str, default="mm_hippo")
    parser.add_argument("--seq_tech", type=str, default="Slide-tags")
    parser.add_argument("--cluster_label", type=str, default="")
    parser.add_argument("--data_folder", type=str, default="/home/wcy/code/datasets/slide-tags/")
    parser.add_argument("--num_classes", type=int, default=10, help="The number of clusters")
...
def main(args):
    ...
    data_path = args.data_folder + args.sample_name + '.h5ad'
    ...
    adata_path = '/home/wcy/code/pyFile/NewFolder/GSG_modified_DLPFH/output/adata/slide-tags/mm_hippo_test.h5ad'
